...
test('/register succeeds for new user', () => {
    ...
    usersDb.userExists.mockImplementation(email => Promise.resolve(false))
    // Mock createUser to work (resolve)
    usersDb.createUser.mockImplementation((email, first_name, last_name, password) => Promise.resolve())
...
test('/register fails for existing user', () => {
    ...
    usersDb.userExists.mockImplementation(email => Promise.resolve(true))
...
test('/register fails for create error', () => {
    ...
    usersDb.createUser.mockImplementation((email, first_name, last_name, password) => Promise.reject())
